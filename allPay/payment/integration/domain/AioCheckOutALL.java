...
public class AioCheckOutALL {
	...
	/**
	 * InstallmentAmount
	 * 使用刷卡分期的總付款金額，刷卡分期的總付款金額。若與交易金額むTotalAmountめ相同時，不需傳入此參數。
	 */
...
//	}
	...
	/**
	 * 取得InstallmentAmount 使用刷卡分期的總付款金額，刷卡分期的總付款金額。若與交易金額むTotalAmountめ相同時，不需傳入此參數。
...
//	}
	/**
	 * 設定InstallmentAmount 使用刷卡分期的總付款金額，刷卡分期的總付款金額。若與交易金額むTotalAmountめ相同時，不需傳入此參數。
